    ...
    items: [
      {
        ...
        how: "The API when there is one, a driven browser when there isn't. Queued jobs, retry after failure, fingerprint deduplication: running it twice never creates a duplicate.",
      },
      {
        key: "ai",
        title: "AI automation",
        line: "n8n, autonomous agents, LLMs in production. Repetitive work disappears from the calendar.",
        how: "n8n for orchestration, and the model called with a structured output — an enforced format, not free text to guess at. Every step is logged, every failure replayable on its own.",
      },
      {
        key: "dashboards",
        title: "Dashboards & control centers",
        line: "An interface built to operate a system, not to admire it.",
        how: "Aggregates computed in the database, not in the browser: the page stays fast across years of history. Access rights enforced at database level, refresh without a page reload.",
      },
      {
        key: "web",
        title: "Web development",
        line: "Next.js, TypeScript, from design to deployment.",
        how: "Next.js 16, server components by default, fonts and images served from your own domain. Core Web Vitals measured before launch, not discovered after.",
      },
      {
        key: "apps",
        title: "Mobile & desktop apps",
        line: "Cross-platform, wired into the systems you already run.",
        how: "One codebase for iOS, Android and the desktop. Offline-capable with a sync queue: the user enters data, the app sends it when the network comes back.",
      },
      {
        key: "chatbots",
        title: "Chatbots & AI assistants",
        line: "Qualification, support, lead capture. The one on this page is one of them.",
        how: "A deterministic qualification script first, the model as a fallback when the question falls outside it. Streamed answers, every conversation stored, and one hard rule: never invent a price or a deadline.",
      },
      {
        key: "ecommerce",
        title: "E-commerce",
        line: "Catalogues, payments, stock and back-office syncing.",
        how: "Payments delegated to a certified provider — no card data ever passes through your systems. Stock synced by webhooks with your back-office, product pages server-rendered so they stay indexable.",
      },
      {
        key: "design",
        title: "Design & branding",
        line: "Interfaces and visual identity that match the product.",
        how: "A token system rather than isolated mockups: colours, scales and spacing defined once, applied everywhere. Contrast checked, motion switched off when the visitor asks for it.",
      },
    ],
  },
