...
export const fr: Dict = {
    ...
    items: [
      {
        ...
        how: "L'API quand elle existe, un navigateur piloté quand elle n'existe pas. File d'attente, reprise après échec, déduplication par empreinte : relancer deux fois ne crée jamais de doublon.",
      },
      {
        key: "ai",
        title: "Automatisation IA",
        line: "n8n, agents autonomes, LLM en production. Les tâches répétitives disparaissent du planning.",
        how: "n8n pour l'orchestration, et le modèle appelé en sortie structurée — un format imposé, pas du texte libre à deviner. Chaque étape est journalisée, chaque échec rejouable sans tout relancer.",
      },
      {
        key: "dashboards",
        title: "Dashboards & control centers",
        line: "Une interface pour piloter un système, pas pour l'admirer.",
        how: "Les agrégats sont calculés en base, pas dans le navigateur : la page reste rapide même sur des années d'historique. Droits d'accès au niveau de la base, et rafraîchissement sans rechargement.",
      },
      {
        key: "web",
        title: "Développement web",
        line: "Next.js, TypeScript, du design au déploiement.",
        how: "Next.js 16, composants serveur par défaut, polices et images servies depuis votre domaine. Les Core Web Vitals sont mesurés avant la mise en ligne, pas découverts après.",
      },
      {
        key: "apps",
        title: "Applications mobile & desktop",
        line: "Multi-plateforme, connectées à vos systèmes existants.",
        how: "Une seule base de code pour iOS, Android et le poste de travail. Fonctionnement hors connexion avec file de synchronisation : l'utilisateur saisit, l'application envoie quand le réseau revient.",
      },
      {
        key: "chatbots",
        title: "Chatbots & assistants IA",
        line: "Qualification, support, capture de leads. Celui de ce site en est un.",
        how: "Un script de qualification déterministe d'abord, le modèle en secours quand la question sort du cadre. Réponses en streaming, conversation enregistrée, et une règle absolue : jamais un prix ni un délai inventé.",
      },
      {
        key: "ecommerce",
        title: "E-commerce",
        line: "Catalogues, paiement, synchronisation stock et back-office.",
        how: "Paiement délégué à un prestataire certifié — aucune donnée bancaire ne transite chez vous. Stock synchronisé par webhooks avec l'outil de gestion, fiches produit rendues côté serveur pour rester indexables.",
      },
      {
        key: "design",
        title: "Design & identité",
        line: "Interfaces et identité visuelle cohérentes avec le produit.",
        how: "Un système de tokens plutôt que des maquettes isolées : couleurs, échelles et espacements définis une fois, appliqués partout. Contrastes vérifiés, animations coupées si le visiteur les refuse.",
      },
    ],
  },
  ...
  reviews: {
    ...
    items: [
      ...
      {
        name: "Jean",
        role: "AfricartMarket · Pipeline data & LLM",
        platform: "Upwork",
        url: "https://www.upwork.com/freelancers/~01e9d7e582881baac8",
        text: "Excellent",
      },
